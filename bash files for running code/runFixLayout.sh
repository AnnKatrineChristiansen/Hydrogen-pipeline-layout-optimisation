...
#source ~/.bashrc
#Initialize: chmod +x runFixLayout.sh
#Kør: ./runFixLayout.sh    
...
instances=("A 2 1" "A 1 1" "B 1 2" "C 1 1" "C 2 1" "D 1 3" "E 1 1" "E 2 2" "E 3 1" "F 1 2" "F 2 1" "G 1 3" "H 1 2" "H 2 1" "J 1 2" "J 2 2" "J 3 1")

solution_filename="12-12_S_MIP_20bar_30min"
...
for instance in "${instances[@]}"; do
    ...
    start_time=$SECONDS
    julia fixLayouts.jl "$solution_filename" "$filename" "$zone" "$number_of_substations" 
